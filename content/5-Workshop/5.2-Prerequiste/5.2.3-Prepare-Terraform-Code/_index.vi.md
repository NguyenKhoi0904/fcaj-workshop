...
![Kết nối và khởi tạo tài nguyên](/fcaj-workshop/images/5-Workshop/5.2-Prerequisite/image5.2.3b.png)

- Mở đường dẫn được hiển thị trên cửa sổ terminal:

![Kết nối và khởi tạo tài nguyên](/fcaj-workshop/images/5-Workshop/5.2-Prerequisite/image5.2.3c.png)

- Nhập Description nếu muốn để dễ dàng nhận biết token.
- Chọn thời gian hết hạn cho API Token.
- Nhấn Generate token.

![Kết nối và khởi tạo tài nguyên](/fcaj-workshop/images/5-Workshop/5.2-Prerequisite/image5.2.3d.png)

- Copy Token vừa tạo vào Terminal:

![Kết nối và khởi tạo tài nguyên](/fcaj-workshop/images/5-Workshop/5.2-Prerequisite/image5.2.3e.png)
...
![Kết nối và khởi tạo tài nguyên](/fcaj-workshop/images/5-Workshop/5.2-Prerequisite/image5.2.3f.png)
