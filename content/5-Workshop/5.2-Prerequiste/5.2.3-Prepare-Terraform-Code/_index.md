...
![](/fcaj-workshop/images/5-Workshop/5.2-Prerequisite/image5.2.3a.png)
...
![Connect and initialize resources](/fcaj-workshop/images/5-Workshop/5.2-Prerequisite/image5.2.3b.png)

- Open the URL shown in the terminal window:

![Connect and initialize resources](/fcaj-workshop/images/5-Workshop/5.2-Prerequisite/image5.2.3c.png)

- Enter a Description if you want, to make the token easy to identify.
- Choose an expiration time for the API Token.
- Click Generate token.

![Connect and initialize resources](/fcaj-workshop/images/5-Workshop/5.2-Prerequisite/image5.2.3d.png)

- Copy the newly created Token into the Terminal:

![Connect and initialize resources](/fcaj-workshop/images/5-Workshop/5.2-Prerequisite/image5.2.3e.png)
...
![Connect and initialize resources](/fcaj-workshop/images/5-Workshop/5.2-Prerequisite/image5.2.3f.png)
