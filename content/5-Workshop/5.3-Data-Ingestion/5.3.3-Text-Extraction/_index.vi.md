...
![Log CloudWatch khi PDF scan chờ xác nhận OCR](../fcaj-workshop/images/06-awaiting-ocr-status.png)
*Ảnh minh họa: log Lambda ghi status `awaiting_ocr_confirmation`, và bảng `ingestion_status` cập nhật tương ứng.*

![Test OCR trả về đúng nội dung từ file ảnh scan](../fcaj-workshop/images/07-textract-ocr-result.png)
